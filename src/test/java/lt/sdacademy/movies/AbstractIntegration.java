...
public abstract class AbstractIntegration {
    ...
    protected <T> T sendGet(String url, TypeReference<T> type, String token) throws Exception {
        return sendRequest(get(url).header("Authorization", "Bearer " + token), type);
    }
